...
export default function AvailableHoursStep({ form, setForm, next, back }) {
    ...
    return (
        <Layout step={4} onNext={next} onBack={back}>
            {/* Onboarding Card */}
            <div className="w-full bg-surface-container-lowest rounded-lg p-8 shadow-[0_10px_30px_rgba(45,42,81,0.06)] border border-outline-variant/10 text-center relative overflow-hidden">
                {/* Decorative background glow */}
                <div className="absolute -top-24 -right-24 w-48 h-48 bg-primary/5 rounded-full blur-3xl"></div>
                <div className="absolute -bottom-24 -left-24 w-48 h-48 bg-secondary/5 rounded-full blur-3xl"></div>
                
                <div className="relative z-10">
                    <h2 className="font-headline font-extrabold text-2xl tracking-tight text-on-surface mb-2">
                    ...
                    <div className="flex flex-col items-center justify-center mb-10">
                        <div className="relative">
                            <span className="text-7xl font-headline font-extrabold text-primary tracking-tighter">{hours}</span>
                            <span className="text-xl font-headline font-bold text-on-surface-variant ml-1">hrs</span>
                        </div>
                    </div>
                    ...
                    <div className="px-2 mb-8">
                        ...
                        />
                        <div className="flex justify-between mt-4 px-1 text-xs font-label font-semibold text-outline">
                            <span>1 hr</span>
                            <span>4 hrs</span>
                            <span>8 hrs</span>
                            <span>12 hrs</span>
                    ...
                    {/* Contextual Hint */}
                    <div className="bg-surface-container-low rounded-xl p-4 flex items-start gap-3 text-left">
            ...
            {/* Aesthetic Imagery */}
            <div className="mt-12 w-full h-48 rounded-lg overflow-hidden relative">
                <img 
